...
date: 18 August 2023 
image: /assets/img/GES-Dashboard/featured_image.png
links:
...
Data from the Graduate Employment Survey from the years 2013 - 2021 was retrieved from [data.gov.sg], a public API repository of datasets related to Singapore.
...
More information about the dataset and the download link can be found [here](https://beta.data.gov.sg/datasets/d_3c55210de27fcccda2ed0c63fdd2b352/view)


## 🖥️ Dashboard 

<figure>
  <img src="{{site.url}}/assets/img/GES-Dashboard/dashboard_overview.png">
...
<figure>
  <img src="{{site.url}}/assets/img/GES-Dashboard/view_one.gif" width="100%" height="auto" />
...
<figure>
  <img src="{{site.url}}/assets/img/GES-Dashboard/view_two.gif" width="100%" height="auto" />
...
<figure>
  <img src="{{site.url}}/assets/img/GES-Dashboard/view_three.gif" width="100%" height="auto" />
  <figcaption>The trend section of the dashboard provides average salaries across years for each university</figcaption>
</figure>

[Play around with the dashboard here]{:target="_blank"}{:.read-more}

<br><br>

**_Further Reading_**

\[1\] More information about the 6 autonomous universities can be found [here](https://www.moe.gov.sg/post-secondary/overview/autonomous-universities/)



<!-- Links -->
[data.gov.sg]: https://beta.data.gov.sg/
[here]: https://beta.data.gov.sg/datasets/d_3c55210de27fcccda2ed0c63fdd2b352/view
